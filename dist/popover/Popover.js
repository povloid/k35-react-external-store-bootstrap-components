...
export var Popover = function (_a) {
    ...
    return (_jsxs("button", { className: "btn btn-link bth-sm", style: { width: 24, height: 24, padding: 0, position: "relative" }, onClick: toggleShow, children: [_jsx(IconMdi, { iname: "information-outline" }), show &&
